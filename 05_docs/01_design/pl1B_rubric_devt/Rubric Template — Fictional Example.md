# Rubric Template — Fictional Example  
Assessment: `PPP` (Professional Practice Portfolio)
This example illustrates how the **Rubric Template** appears once populated with exemplar structures for one component: `SectionAResponse`.
