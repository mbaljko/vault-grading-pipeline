...
````md
WRAPPER PROMPT — SEGMENTATION (AP2D)

From this assignment, student submissions are expected to consist of **three institutional constraint entries**, each following the AP2D Section D structure.
