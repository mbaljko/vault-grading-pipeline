...
```md
WRAPPER PROMPT — SEGMENTATION (AP2B)
...
5. Ignore template labels or guidance text if present (e.g., “Claim statement (aim 35–45 words)”); extract only the claim content itself when separable.
