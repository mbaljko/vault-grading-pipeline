...
````md
WRAPPER PROMPT — SEGMENTATION (AP1D)

From this assignment, student submissions are expected to consist of **three institutional constraint entries**, each following the AP1D Section D structure.
