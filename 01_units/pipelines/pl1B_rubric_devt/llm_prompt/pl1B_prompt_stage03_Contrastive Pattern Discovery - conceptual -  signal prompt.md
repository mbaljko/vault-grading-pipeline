The two signal types belong to **different analytic logics**, and a single abstract wrapper prompt will almost always drift between them unless it explicitly commits to one logic.
Engagement signals answer:
> _How is the student engaging with the task?_

Conceptual interpretation signals answer:
> _What conceptual position is the student expressing?_
