...
from component_scored_texts_non_Layer0_consuming import (
	load_scored_rows_from_paths,
	resolve_component_scored_csv_paths,
)
...
PANEL_REPORT_COLLECTOR_SCRIPT_RELATIVE = Path(
	"01_units/pipelines/pl1C_rubric_devt/python/collect-itp-panel-reports_non_Layer0_consuming.py"
)
